...
app_gcp.config['MAX_CONTENT_LENGTH'] = 1024 * 1024
app_gcp.config['UPLOAD_EXTENSIONS'] = ['.jpg', '.jpeg', '.png', '.pdf']
...
if __name__ == "__main__":
    #app.run(debug=True)
    app_gcp.run(host='0.0.0.0', port=5000, debug=True)
